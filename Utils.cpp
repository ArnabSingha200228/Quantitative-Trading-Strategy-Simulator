...
void callPythonDownload(const std::string& symbol, const std::string& start_date, const std::string& end_date) {
    std::string cmd = "python download_data.py " + symbol + " " + start_date + " " + end_date;
